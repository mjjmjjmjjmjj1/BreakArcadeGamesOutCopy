...
internal f32 draw_number(int number, v2 p, f32 size, u32 color, int number_of_leading_zeros);
...
#define draw_profiler_guy(name, index) {\
        ...
        draw_number(back_profiling_data[index].hit_count, add_v2((v2){6, -1}, p), 2.f, color, 1);\
